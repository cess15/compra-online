...
return [
    ...
    */
    ...
    'attributes' => [
        'per_name' => 'primer nombre',
        'per_second_name' => 'segundo nombre',
        'per_lastname' => 'primer apellido',
        'per_second_lastname' => 'segundo apellido',
        'email' => 'correo electrónico',
        'pers_identification' => 'número de identificación',
        'name' => 'nombre'
    ],
